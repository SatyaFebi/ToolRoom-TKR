...
return new class extends Migration
{
    ...
    {
        Schema::connection('tkr_service_management')->create('service_orders_old', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::connection('tkr_service_management')->dropIfExists('service_orders_old');
    }
};
